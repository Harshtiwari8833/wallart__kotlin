...
import com.maverickbits.wallart.databinding.ActivityOpenOneCatWallBinding
import com.maverickbits.wallart.databinding.ActivityOpenOneWallBinding

class OpenOneCatWallActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityOpenOneCatWallBinding.inflate(layoutInflater)
        setContentView(binding.root)
        var img = intent.getStringExtra("value")
